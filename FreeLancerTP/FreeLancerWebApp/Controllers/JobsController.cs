...
namespace FreeLancerWebApp.Controllers
{
    public class JobsController : Controller
    {
        ...
        public JobsController(FreeLancerDbContext context)
        {
            _context = context;
        }
        ...
        {
            var freeLancerDbContext = _context.Jobs.Include(j => j.Customer);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,State,Title,Start,End,Description,CustomerID")] Job job)
        {
            if (id != job.ID)
            {
                return NotFound();
